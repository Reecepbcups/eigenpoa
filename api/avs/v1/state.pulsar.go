...
func init() {
	file_avs_v1_state_proto_init()
	md_ExampleData = File_avs_v1_state_proto.Messages().ByName("ExampleData")
...
func (x *ExampleData) slowProtoReflect() protoreflect.Message {
	mi := &file_avs_v1_state_proto_msgTypes[0]
...
func (x *fastReflection_ExampleData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "avs.v1.ExampleData.account":
		return len(x.Account) != 0
	case "avs.v1.ExampleData.amount":
		return x.Amount != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: avs.v1.ExampleData"))
		}
		panic(fmt.Errorf("message avs.v1.ExampleData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ExampleData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message avs.v1.ExampleData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ExampleData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "avs.v1.ExampleData.account":
		panic(fmt.Errorf("field account of message avs.v1.ExampleData is not mutable"))
	case "avs.v1.ExampleData.amount":
		panic(fmt.Errorf("field amount of message avs.v1.ExampleData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: avs.v1.ExampleData"))
		}
...
func (x *fastReflection_ExampleData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in avs.v1.ExampleData", d.FullName()))
	}
	panic("unreachable")
}
...
func (*ExampleData) Descriptor() ([]byte, []int) {
	return file_avs_v1_state_proto_rawDescGZIP(), []int{0}
}
...
var File_avs_v1_state_proto protoreflect.FileDescriptor

var file_avs_v1_state_proto_rawDesc = []byte{
	0x0a, 0x12, 0x61, 0x76, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x61, 0x76, 0x73, 0x2e, 0x76, 0x31, 0x1a, 0x17, 0x63, 0x6f,
	...
	,
}

var (
	file_avs_v1_state_proto_rawDescOnce sync.Once
	file_avs_v1_state_proto_rawDescData = file_avs_v1_state_proto_rawDesc
)

func file_avs_v1_state_proto_rawDescGZIP() []byte {
	file_avs_v1_state_proto_rawDescOnce.Do(func() {
		file_avs_v1_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_avs_v1_state_proto_rawDescData)
	})
	return file_avs_v1_state_proto_rawDescData
}

var file_avs_v1_state_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_avs_v1_state_proto_goTypes = []interface{}{
	(*ExampleData)(nil), // 0: avs.v1.ExampleData
}
var file_avs_v1_state_proto_depIdxs = []int32{
...
func init() { file_avs_v1_state_proto_init() }
func file_avs_v1_state_proto_init() {
	if File_avs_v1_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_avs_v1_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_avs_v1_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_avs_v1_state_proto_goTypes,
		DependencyIndexes: file_avs_v1_state_proto_depIdxs,
		MessageInfos:      file_avs_v1_state_proto_msgTypes,
	}.Build()
	File_avs_v1_state_proto = out.File
	file_avs_v1_state_proto_rawDesc = nil
	file_avs_v1_state_proto_goTypes = nil
	file_avs_v1_state_proto_depIdxs = nil
}
