...
#
# Examples:
# CHAIN_ID="localchain-1" HOME_DIR="~/.eigenpoa" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="localchain-2" HOME_DIR="~/.eigenpoa" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.eigenpoa"}")
export BINARY=${BINARY:-eigned}
...
from_scratch () {
  ...
  # eigen1efd63aw40lxf3n4mhf7dzhjkr453axurqmgezj
  ...
  # eigen1hj5fveer5cjtn4wd6wstzugjfdxzl0xpu0matm
  ...
  update_test_genesis '.consensus["params"]["abci"]["vote_extensions_enable_height"]="10"'
